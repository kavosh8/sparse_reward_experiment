...
class LunarLander(gym.Env, EzPickle):
    ...
    def __init__(self,prob_of_shape):
        self.prob_of_shape=prob_of_shape
    ...
    def step(self, action):
        ...
        if self.prev_shaping is not None and numpy.random.random()<self.prob_of_shape:
            #print("shape")
